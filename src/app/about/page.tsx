      ...
      <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-b border-amber-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-[#0C234B] mb-4">About PlumaUA</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-[#0C234B] mb-4">Our Mission</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#0C234B] mb-2">Conservation</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#0C234B] mb-2">Education</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#0C234B] mb-2">Community</h3>
              <p className="text-gray-600">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-gradient-to-br from-amber-100 to-orange-100 rounded-lg p-8 text-center">
              ...
              <h3 className="text-xl font-semibold text-[#0C234B] mb-2">Xin Huang</h3>
              <p className="text-gray-600 mb-4">Founder & Lead Birder</p>
        ...
        {/* What We Do */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
          <h2 className="text-3xl font-bold text-[#0C234B] mb-6 text-center">What We Do</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-lg p-3 flex-shrink-0">
                  <Camera className="h-6 w-6 text-[#AB0520]" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-[#0C234B] mb-2">Document Bird Life</h3>
                  <p className="text-gray-600">
              ...
              <div className="flex items-start space-x-4">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-3 flex-shrink-0">
                  <BookOpen className="h-6 w-6 text-[#AB0520]" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-[#0C234B] mb-2">Educational Resources</h3>
                  <p className="text-gray-600">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-3 flex-shrink-0">
                  <Users className="h-6 w-6 text-[#AB0520]" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-[#0C234B] mb-2">Community Events</h3>
                  <p className="text-gray-600">
              ...
              <div className="flex items-start space-x-4">
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-3 flex-shrink-0">
                  <Heart className="h-6 w-6 text-[#AB0520]" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-[#0C234B] mb-2">Conservation Efforts</h3>
                  <p className="text-gray-600">
        ...
        <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg p-8 mb-8">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-[#0C234B] mb-4">Get Involved</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/sightings" className="group">
              <div className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow text-center">
                ...
                <h3 className="text-lg font-semibold text-[#0C234B] mb-2">Report Sightings</h3>
            ...
            <Link href="/blog" className="group">
              <div className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow text-center">
                ...
                <h3 className="text-lg font-semibold text-[#0C234B] mb-2">Join Events</h3>
                <p className="text-gray-600 mb-4">
            ...
            <Link href="/birds" className="group">
              <div className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow text-center">
                ...
                <h3 className="text-lg font-semibold text-[#0C234B] mb-2">Learn More</h3>
                <p className="text-gray-600 mb-4">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          <h2 className="text-3xl font-bold text-[#0C234B] mb-6 text-center">Contact & Connect</h2>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-semibold text-[#0C234B] mb-4">Get in Touch</h3>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <Mail className="h-5 w-5 text-[#AB0520]" />
                  <a 
                    href="mailto:contact@plumaua.org" 
                    className="text-gray-600 hover:text-[#AB0520] transition-colors"
                  >
                    contact@plumaua.org
                  </a>
                </div>
            ...
            <div>
              <h3 className="text-xl font-semibold text-[#0C234B] mb-4">Follow Us</h3>
              <div className="space-y-4">
                <a 
                  href="https://twitter.com/plumaua" 
                  className="flex items-center space-x-3 text-gray-600 hover:text-[#AB0520] transition-colors"
                >
