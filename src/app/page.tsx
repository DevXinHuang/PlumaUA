...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-amber-50 via-orange-50 to-red-50 dark:from-amber-900/20 dark:via-orange-900/20 dark:to-red-900/20 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex justify-center mb-6">
              <BirdIcon className="h-16 w-16 text-[#AB0520]" />
            </div>
            <h1 className="text-4xl md:text-6xl font-bold text-[#0C234B] dark:text-white mb-6">
      ...
      <section className="py-16 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Bird of the Week</h2>
            <p className="text-gray-600 dark:text-gray-400">Featured species spotted on campus</p>
          </div>
          
          <div className="bg-gradient-to-r from-amber-50 via-orange-50 to-red-50 dark:from-amber-900/20 dark:via-orange-900/20 dark:to-red-900/20 rounded-2xl p-8 border border-amber-200 dark:border-amber-800/30">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold text-[#0C234B] dark:text-white mb-2">{birdOfTheWeek.name}</h3>
                <p className="text-gray-600 dark:text-gray-400 italic mb-4">{birdOfTheWeek.scientificName}</p>
                <p className="text-gray-700 dark:text-gray-300 mb-4">{birdOfTheWeek.description}</p>
              ...
              <div className="bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900/30 dark:to-orange-900/30 rounded-lg h-64 flex items-center justify-center border border-amber-200 dark:border-amber-800/30">
                <span className="text-amber-700 dark:text-amber-300">Bird Image Placeholder</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Link href="/birds" className="group">
              <div className="bg-white dark:bg-gray-900 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow border border-gray-100 dark:border-gray-700">
                <BirdIcon className="h-12 w-12 text-[#AB0520] mb-4" />
                <h3 className="text-xl font-semibold text-[#0C234B] dark:text-white mb-2">Bird Directory</h3>
                <p className="text-gray-600 dark:text-gray-400 mb-4">Browse our comprehensive guide to campus birds</p>
            ...
            <Link href="/map" className="group">
              <div className="bg-white dark:bg-gray-900 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow border border-gray-100 dark:border-gray-700">
                ...
                <h3 className="text-xl font-semibold text-[#0C234B] dark:text-white mb-2">Interactive Map</h3>
                <p className="text-gray-600 dark:text-gray-400 mb-4">See where birds have been spotted on campus</p>
                <span className="text-[#AB0520] group-hover:text-red-800 font-semibold">
                  View Map →
                </span>
              </div>
            ...
            <Link href="/sightings" className="group">
              <div className="bg-white dark:bg-gray-900 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow border border-gray-100 dark:border-gray-700">
                ...
                <h3 className="text-xl font-semibold text-[#0C234B] dark:text-white mb-2">Report Sighting</h3>
                <p className="text-gray-600 dark:text-gray-400 mb-4">Share your bird observations with the community</p>
                <span className="text-[#AB0520] group-hover:text-red-800 font-semibold">
                  Submit Sighting →
                </span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-12">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">Stories, tips, and insights from the PlumaUA community</p>
            </div>
            <Link 
              href="/blog" 
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {latestPosts.map((post) => (
              <article key={post.id} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 hover:shadow-md transition-shadow">
