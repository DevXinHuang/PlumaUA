        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/birds" className="text-gray-300 hover:text-green-400 transition-colors">
                  Bird Directory
                </Link>
              </li>
              <li>
                <Link href="/sightings" className="text-gray-300 hover:text-green-400 transition-colors">
                  Recent Sightings
                </Link>
              </li>
              <li>
                <Link href="/map" className="text-gray-300 hover:text-green-400 transition-colors">
                  Interactive Map
                </Link>
              </li>
              <li>
